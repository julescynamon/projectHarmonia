...
function generateCalendarLinks(appointment) {
  const startDate = /* @__PURE__ */ new Date(`${appointment.date}T${appointment.time}`);
  const endDate = new Date(startDate.getTime() + 90 * 6e4);
...
export { sendAppointmentNotification as s };

...
const $$Reservation = createComponent(async ($$result, $$props, $$slots) => {
  const seo = {
    title: "R\xE9server un soin chamanique - Naima Tyzra",
    description: "Prenez rendez-vous pour un soin chamanique personnalis\xE9 : soins quantiques, communication animale, rituels de transmutation et nettoyage \xE9nerg\xE9tique."
  };
  const services = [
    {
      ...
      duration: "1h30",
      price: "120\u20AC",
      description: "Soin chamanique profond pour harmoniser corps, \xE2me et esprit",
    ...
    },
    {
      ...
      duration: "2h",
      price: "150\u20AC",
      description: "Soin chamanique quantique pour une transformation profonde de l'\xEAtre",
      icon: "psychology"
    },
    {
      ...
      duration: "1h",
      price: "100\u20AC",
      description: "Soin chamanique adapt\xE9 aux besoins \xE9nerg\xE9tiques de votre animal",
      icon: "pets"
    },
    {
    ...
    },
    {
      ...
      title: "Rituels de Transmutation \xC9nerg\xE9tique",
      duration: "1h30",
      price: "130\u20AC",
      description: "Rituels sacr\xE9s pour transmuter les \xE9nergies et lib\xE9rer les blocages",
      icon: "auto_fix_high"
    },
    {
      id: "nettoyage-energetique",
      title: "Nettoyage \xC9nerg\xE9tique des Lieux",
      duration: "2h",
      price: "180\u20AC",
      description: "Purification et harmonisation \xE9nerg\xE9tique de votre espace de vie",
      icon: "home"
    }
  ];
  const timeSlots = [
  ...
  const steps = [
    {
      ...
      description: "S\xE9lectionnez le type de soin chamanique qui correspond \xE0 vos besoins.",
      icon: "assignment"
    },
    {
